    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('admin', 'Administrador'), ('user', 'Usuario')], default='user', max_length=20, verbose_name='user type')),
                ...
                ('language', models.CharField(choices=[('es', 'Español'), ('en', 'Inglés')], default='es', max_length=10, verbose_name='language')),
